<template>
  <div class="is-tetrad">
    <section class="hero">
      <div class="hero-body">
        <div class="container has-text-left">
          ...
          <h2 class="subtitle">
            The tetrad color scheme uses four colors equally spaced around the hue circle.
          </h2>
        </div>
      </div>
    </section>
    <div class="columns" v-bind:class="tIsX">
      ...
      <div class="column" v-bind:class="cIsX4">{{colorCode4}}</div>
    </div>
    <div class="columns" v-bind:class="tIsX">
      <div class="column">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <div class="content has-text-left">
              ...
              <div class="field is-grouped is-grouped-multiline">
                ...
                <div class="control">
                  <div class="tags has-addons">
                    <span class="tag" v-bind:class="cIsX4">HTML</span>
                    <a class="tag is-delete"></a>
                  </div>
                </div>
                <div class="control">
                ...
                <div class="control">
                  <div class="tags has-addons">
                    <span class="tag" v-bind:class="cIsX4">Web Design</span>
                    <a class="tag is-delete"></a>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    select: function() {
      let tetradColors = this.getTetrad()
      this.cIsX2 = 'c-is-' + tetradColors[0]
      this.cIsX3 = 'c-is-' + tetradColors[1]
      this.cIsX4 = 'c-is-' + tetradColors[2]
      const colors = this.getColors()
      this.colorCode2 =  colors[tetradColors[0]]
      this.colorCode3 =  colors[tetradColors[1]]
      this.colorCode4 =  colors[tetradColors[2]]
    },
    ...mapMutations({
